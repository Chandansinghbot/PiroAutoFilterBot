...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🐣 𝗔𝗻𝗶𝗺𝗲 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🐣', url=f"https://t.me/crunchyroll_dub_in_hindi")
                  ]]
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 🧑‍💻𝗘𝗹𝗶𝘁𝗲𝗖𝗿𝗮𝗳𝘁 𝗦𝘁𝘂𝗱𝗶𝗼𝘀⚔️', url="https://t.me/elitecraft_studios") ] ] ),
            )
        return
